...
module.exports = (client) => {
    ...
    client.on("ready", () => {
        setInterval(() => {
            ...
            if (stateswitch) client.user.setActivity(`${config.prefix}help`, {
                type: "PLAYING"
            });
            else client.user.setActivity(`${usercount} User | ${client.guilds.cache.size} Server`, {
                type: "PLAYING"
            });
        }, 5000); //5 second delay
    ...
    function getAll(client, guild) {
        const embed = new MessageEmbed()
            ...
            .setDescription('Help Menu - THANKS FOR INVITING ME!')
