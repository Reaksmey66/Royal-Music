...
module.exports = (client) => {
    ...
    client.on('ready', () => {
        ...
        client.api.applications(client.user.id).commands.post({
            data: {
                name: "info",
                description: "See some information about Royal Music"
            }
        });
        client.api.applications(client.user.id).commands.post({
        ...
        client.ws.on('INTERACTION_CREATE', async interaction => {
            ...
            const inviteembed = new Discord.MessageEmbed()
                ...
                .setDescription(`[\`SUPPORT\`](https://discord.gg/naUJjDSf8E)   |   :heart: Thanks for inviting!`)
            ...
            `)
                ...
                .addField("***SUPPORT:***", `
            >>> [\`Server\`](https://discord.gg/naUJjDSf8E)
            `)
            const helpembed = new Discord.MessageEmbed()
                ...
                *more coming soon*
                ...
                >>> \`Youtube\`, \`Spotify\`, \`Soundcloud\`, [\`More\`](https://discord.gg/naUJjDSf8E), ...
                `)
