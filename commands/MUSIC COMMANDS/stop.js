...
module.exports = {
    ...
    run: async (client, message, args) => {
        ...
        functions.embedbuilder(client, "null", message, config.colors.no, `Thanks For Using our Service

**Loving the bot?**
Consider becoming a [patreon](https://discord.gg/naUJjDSf8E) to support our hard work and the future development of the bot, even just a dollar if you can :heart:`, `https://media.discordapp.net/attachments/842229048754044978/871326502510264350/received_260868872152767.jpeg`)
