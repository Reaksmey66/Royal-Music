...
module.exports = {
    ...
    run: async (client, message, args) => {
        // code here
        message.guild.channels.create("Royal Music - Requests", {
            type: 'category',
            ...
            message.guild.channels.create(`🎧｜Royal Music`, {
                ...
                message.guild.channels.create(`🎵｜requests`, {
                    ...
                    topic: `To request a Track, simply Type the **SONG NAME** into the Channel or the **URL** and the Bot will play it! Make sure that you are in the **right** Voice Channel (🎧｜Royal Music)!`,
                    parent: channel1.id,
                    permissionOverwrites: [{
                        id: message.guild.id,
                    ...
                    let pehla = new MessageEmbed()
                        ...
                        .setTitle("Royal Music | Request | Guide")
                        .setDescription(`Enter the song name or URL to play a song\n\n For Example ${config.prefix}play \`Rockstar baby song\``)
                        .setFooter("Royal Music")

                    let dusra = new MessageEmbed()
                        .setColor(config.colors.yes)
                        .setThumbnail(client.user.displayAvatarURL())
                        .setAuthor(message.author.username)
                        .setTitle("Royal Music")
                        .setDescription(`Join a voice channel and enter a song name or url to play.\n[Invite Royal Music Music](https://discord.com/api/oauth2/authorize?client_id=837283899414806618&permissions=8&scope=bot) • [Join Server](https://discord.gg/naUJjDSf8E)`)
